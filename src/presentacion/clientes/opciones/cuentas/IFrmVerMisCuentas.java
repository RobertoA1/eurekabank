...
public class IFrmVerMisCuentas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tituloPanel.setText("Estás viendo tus cuentas bancarias");
        ...
        tipSaludo.setText("¡Hola, usuarioPlaceholder! ");
        ...
        tipCuentasContratadas1.setText("Selecciona alguna de tus cuentas y presiona el botón debajo");
        ...
        tipCuentasContratadas2.setText("Estas son todas las cuentas que tienes contratadas");
        ...
        tipCuentasContratadas3.setText("¿Deseas ver el historial de movimientos?");
    ...
    private void btnVerHistorialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerHistorialActionPerformed
        ...
        if (row == -1) {
            JOptionPane.showMessageDialog(this, "Ver mis Transacciones | No se ha seleccionado una cuenta.", "Un problema ha ocurrido...", JOptionPane.ERROR_MESSAGE);
            return;
        }
        Cuenta cuenta = cuentas.get(row);
        IFrmVerHistorial historial = IFrmVerHistorial.getInstance(cuenta);
        FrmClientes.centrarInternalFrameExterno(historial);
    ...
    public static IFrmVerMisCuentas getInstance(){
        form = new IFrmVerMisCuentas();
        return form;
    }
