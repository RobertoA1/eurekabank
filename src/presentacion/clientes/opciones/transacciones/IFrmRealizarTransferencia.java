...
public class IFrmRealizarTransferencia extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(labelNumeroCuenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 340, 250, -1));
        ...
        jPanel2.add(btnRealizarTransferencia, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 390, 190, 50));
        ...
        tipTipoTransfer.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        tipTipoTransfer.setText("Por favor, selecciona tu cuenta con la que realizarás la operación");
        jPanel2.add(tipTipoTransfer, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 90, 620, -1));
        jPanel2.add(txtNumeroCuenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 340, 270, -1));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 120, 480, 180));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 620, 470));
    ...
    private void rellenarInfoTabla(Cliente cliente){
        try {
            Object[] cols = {"Número de Cuenta", "Moneda", "Saldo"};
    ...
    private void btnRealizarTransferenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRealizarTransferenciaActionPerformed
        try {
            Cuenta cuentaReceptora = Cuentas.obtener(txtNumeroCuenta.getText());

            int cuentaSelec = tablaCuentas.getSelectedRow();
            if (cuentaSelec == -1) {
                JOptionPane.showMessageDialog(this, "Realizar una transferencia | No se ha seleccionado una cuenta.", "Un problema ha ocurrido...", JOptionPane.ERROR_MESSAGE);
                return;
            }
            Cuenta cuentaEmisora = cuentas.get(cuentaSelec);
            Usuario usuario = Autenticacion.obtenerUsuario();
            Cliente clienteEmisor = Clientes.obtenerClientePorUsuario(usuario.getCodigo());
            Cliente clienteReceptor = Clientes.obtener(cuentaReceptora.getCodigoCliente());
            
            if (cuentaEmisora.getCodigoCliente().equalsIgnoreCase(cuentaReceptora.getCodigoCliente())){
                JOptionPane.showMessageDialog(this, "Realizar una transferencia | No puedes realizar una transferencia a ti mismo.", "Un problema ha ocurrido...", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            FrmClientes.centrarInternalFrameExterno(form);
        } catch (IllegalArgumentException e){
            JOptionPane.showMessageDialog(this, e.getMessage(), "Un problema ha ocurrido...", JOptionPane.ERROR_MESSAGE);
            System.out.println(e.getMessage());
        } catch (IllegalStateException e){
