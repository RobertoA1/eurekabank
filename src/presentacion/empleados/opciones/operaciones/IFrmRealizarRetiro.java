...
public class IFrmRealizarRetiro extends javax.swing.JInternalFrame {
    ...
    private IFrmRealizarRetiro() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Retiros | Ha ocurrido un problema mientras nos conectabamos a la BD. Por favor, cierra el programa y vuelve a intentarlo.", "Un problema ha ocurrido...", JOptionPane.ERROR_MESSAGE);
            System.out.println(e.getMessage());
        }
    }
    ...
    private void initComponents() {
        ...
        tituloPanel.setText("Realizar un retiro de una cuenta");
        ...
        btnRealizarDeposito.setText("Realizar retiro");
        ...
        tipRealizandoTransf.setText("Estás realizando un retiro");
    ...
    private void btnRealizarDepositoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRealizarDepositoActionPerformed
        try {
            ...
            GestorTransacciones.retirar(cuenta.getCodigo(), monto, empleado.getCodigo());
            JOptionPane.showMessageDialog(this, "El retiro se realizó correctamente.", "Retiro realizado", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
        } catch (IllegalArgumentException e){
            JOptionPane.showMessageDialog(this, e.getMessage(), "Un problema ha ocurrido...", JOptionPane.ERROR_MESSAGE);
            System.out.println(e.getMessage());
